...
class TestDKeyWithParameters:
    ...
    def test_no_params(self):
        ...
        assert(isinstance(key, str))
        assert(key._fmt_params is None)
        assert(key._exp_type is dkey.identity)
