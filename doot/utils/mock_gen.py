...
def mock_tasker_spec(mocker):
    ...
    tasker_m.spec.queue_behaviour                = "default"
    type(tasker_m.spec).actions                       = mocker.PropertyMock(return_value=mock_action_spec(mocker, num=0))
    return tasker_m
...
def mock_task_spec(mocker, action_count=0):
    ...
    task_m.spec.queue_behaviour          = "default"
    task_m.state                               = {}
...
def mock_task(mocker, name, pre=None, post=None):
    ...
    mock_task.spec.queue_behaviour        = "default"
