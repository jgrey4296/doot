...
class _Expansion_m:
    ...
    def connect(self, left:None|Concrete[TaskName]|TaskArtifact, right:None|False|Concrete[TaskName]|TaskArtifact=None, **kwargs:Any) -> None:
        """
...
class TaskNetwork(_Expansion_m, _Validation_m, TaskMatcher_m):
