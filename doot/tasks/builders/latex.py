...
interaction_mode  : Final[str] = doot.config.on_fail("nonstopmode", str).tex.interaction()
tex_dep           : Final[str] = doot.config.on_fail("tex.dependencies", str).text.dep_file()
