#!/usr/bin/env python3
"""
Doot Tasks for working with threads
"""
##-- imports
...
class ThreadListings(globber.DirGlobMixin, globber.DootEagerGlobber, ActionsMixin):
    """
...
class OrgMultiThreadCount(globber.DirGlobMixin, globber.DootEagerGlobber, ActionsMixin):
    """
    find org files with multiple threads
    """
...
class ThreadImageOCR(globber.DirGlobMixin, globber.DootEagerGlobber, ActionsMixin):
    """
    TODO OCR all files for all thread directories,
